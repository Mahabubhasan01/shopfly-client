...
const HeaderCategory = () => {
  ...
  return (
    <div>
      <div class="bg-gray-200 leanding-normal tracking-wide">
        <h1
          class="mx-12 my-10 text-gray-700 text-5xl lg:text-6xl text-center"
          style={headingStyle}
        >
        ...
        <div class="container mx-auto w-full overflow-hidden relative">
          ...
          >
            ...
            >
              ...
              <button class="absolute top-0 right-0 bg-teal-400 rounded-full px-1 py-0 font-bold text-lg">
                +
              </button>
              ...
              <button class="mt-4 mb-2 bg-teal-400 rounded-full px-12 py-1 text-gray-100 font-semibold hover:bg-teal-300 focus:outline-none">
                Button
              </button>
            </div>
