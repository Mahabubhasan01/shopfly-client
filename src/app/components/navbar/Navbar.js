    ...
    <div>
      ...
      <div className="navbar bg-base-100">
        <div className="navbar-start">
          ...
          <a className=" normal-case text-xl">SHOPFLY</a>
        </div>
        <div className="navbar-center hidden lg:flex">
          <div class=" bg-gray-100 flex justify-center items-center px-20">
            <div class="">
              <div class="flex items-center p-4 space-x-4 bg-white rounded-xl shadow-xs hover:shadow-sm transform hover:scale-105 transition duration-500">
